...
pub mod prelude {
    ...
    pub use bevy_ecs;
    pub use ctor;
    pub use lumberjack_dump;
    pub use lazy_static;
    pub use retour;
    pub use clap;
    pub use tracing;
    pub use crate::{CanopyMod, CanopyError, app::CanopyAppExt, world::CanopyWorldExt};
}
...
pub trait CanopyMod {
    ...
    fn build(&self, app: &mut App) -> crate::Result<()>;
}
